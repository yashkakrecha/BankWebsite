...
<head>
    ...
    define("bankName", "Sparks Project : Our Bank");
...
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Bank Internship Project</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
